...
### 2.3 Design Principle: What You See Is What You Get
...
### 2.4 Design Principle: Single Weight

Sergamon ships a single weight. There is no bold, light, or any other variant. Every character renders with the same stroke regardless of the `font-weight` CSS property. This is inspired by classic hardware terminals, where text had one uniform appearance.
...
```json
{
  "font": {
    "familyName": "Sergamon",
    "version": "1.0.0",
    "description": "Monospaced font for nostalgic hackers",
    "designer": "",
    "url": ""
  },
  "grid": {
...
- One-line description: "Monospaced font for nostalgic hackers"
...
- Full grid of all available glyphs organized by category (ASCII, Latin Extended)
...
4. **Feature highlights**: monospace, pixel-art, no ligatures (WYSIWYG), single weight, designed for code
